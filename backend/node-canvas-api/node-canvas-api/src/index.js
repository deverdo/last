...
module.exports.storeCustomData = require('./storeCustomData');
module.exports.getCourseFile = require('./getCourseFile');
module.exports.getCourseExtraInfo = require('./getCourseExtraInfo');
module.exports.getToken = require('./getToken');
module.exports.getUserCustomData = require('./getUserCustomData');
module.exports.deleteUserCourseEnrollment = require('./deleteUserCourseEnrollment');
module.exports.getUserEnrollment = require('./getUserEnrollment');
module.exports.logoutUser = require('./logoutUser');
module.exports.searchUser = require('./searchUser');
module.exports.terminateUserSession = require('./terminateUserSession');
module.exports.courseCopy = require('./courseCopy');